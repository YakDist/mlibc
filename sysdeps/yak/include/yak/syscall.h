...
#define syscall(...)                                                                                                                             \
	SYSCALL_SELECT(__VA_ARGS__, _SYSCALL6_CAST, _SYSCALL5_CAST, _SYSCALL4_CAST, _SYSCALL3_CAST, _SYSCALL2_CAST, _SYSCALL1_CAST, _SYSCALL0_CAST)( \
	    __VA_ARGS__                                                                                                                              \
	)
...
#define _SYSCALL2_CAST(num, arg1, arg2) __syscall2((int)(num), (uint64_t)(arg1), (uint64_t)(arg2))

#define _SYSCALL3_CAST(num, arg1, arg2, arg3)                                                      \
	__syscall3((int)(num), (uint64_t)(arg1), (uint64_t)(arg2), (uint64_t)(arg3))
